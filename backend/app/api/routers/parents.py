    ...
    for d in demandes_tri:
        ...
        rows.append(
            TransparenceInscriptionOut(
                ...
                inscription_at=_dt_aware_utc(d.inscription_at),
                created_at=_dt_aware_utc(d.created_at),
...
def _to_demande_out(db: Session, demande: DemandeInscription) -> DemandeOut:
    ...
    return DemandeOut(
        ...
        date_inscription=when,
        inscription_at=_dt_aware_utc(demande.inscription_at),
        created_at=_dt_aware_utc(demande.created_at),
